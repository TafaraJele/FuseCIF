...
export const LOAD_AGENTS = '[Agents resolver] Load agencies'
export const AGENTS_LOADED = '[Agents service] Agencies loaded'
export const LOAD_FILES = '[Files resolver] Load files'
export const FILES_LOADED = '[Files service] File metadata loaded'
...
export class FilesLoaded implements Action {
  readonly type = FILES_LOADED
  constructor() {}
}
